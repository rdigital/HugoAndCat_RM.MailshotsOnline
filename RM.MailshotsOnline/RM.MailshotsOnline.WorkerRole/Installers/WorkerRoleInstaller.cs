...
namespace RM.MailshotsOnline.WorkerRole.Installers
{
    public class WorkerRoleInstaller : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            container.Register(Classes.FromAssemblyInDirectory(new AssemblyFilter(AssemblyDirectory)).BasedOn<ThreadedRoleEntryPoint>().LifestyleTransient(),
                Component.For<ILogger>().ImplementedBy<ILogger>().LifestyleTransient(),
