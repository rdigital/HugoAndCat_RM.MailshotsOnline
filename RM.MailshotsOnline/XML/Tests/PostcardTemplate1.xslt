...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:rx="http://www.renderx.com/XSL/Extensions">
  ...
  <xsl:template name="pageContentFront">
    <!-- Header -->
    <fo:block-container position="fixed" top="0mm" left="105mm" height="19mm" width="100%" display-align="center" text-align="center" letter-spacing="-0.02em">
    ...
    <!-- Body content -->
    <fo:block-container position="fixed" top="19mm" left="105mm" bottom="0mm" right="0mm" display-align="before" text-align="left" letter-spacing="0em" linefeed-treatment="preserve">
      <xsl:attribute name="background-color">
    ...
    <!-- Image -->
    <fo:block-container position="fixed" top="0mm" left="0mm" right="105mm" bottom="0mm" text-align="center" display-align="center">
      <fo:block>
