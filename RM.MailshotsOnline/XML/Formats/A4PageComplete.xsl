...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:rx="http://www.renderx.com/XSL/Extensions">
  ...
  <xsl:template name="pageContentFront">
    <!-- Header -->
    <fo:block-container linefeed-treatment="preserve" position="fixed" top="10mm" left="0mm" height="24mm" width="100%" background-color="orange" display-align="center" text-align="center" font-family="Helvetica" font-size="40pt" line-height="40pt" color="black" letter-spacing="-0.02em">
      <fo:block margin-left="0mm" margin-right="0mm" margin-top="0mm" margin-bottom="0mm">
        <xsl:value-of select="heading"/>
      </fo:block>
    </fo:block-container>
    
    <!-- Body content -->
    <fo:block-container linefeed-treatment="preserve" position="fixed" top="40mm" left="0mm" height="70mm" width="100%" background-color="black" display-align="before" text-align="left" font-family="Helvetica" font-size="12pt" line-height="12pt" letter-spacing="0em" color="white">
      <fo:block margin-left="0mm" margin-right="0mm" margin-top="0mm" margin-bottom="0mm">
